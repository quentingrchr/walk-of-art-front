                ...
                <div>
                    {
                        filterWorksList(works, filters).map((work, index) => (
                            (index % 3) === 0 && <CardGallery key={work.id} title={work.title} createdAt={work.created_at} id={""}/>
                        ))
                    }
                </div>
                <div>
                    {
                        filterWorksList(works, filters).map((work, index) => (
                            (index % 3) === 1 && <CardGallery key={work.id} title={work.title} createdAt={work.created_at} id={""}/>
                        ))
                    }
                </div>
                <div>
                    {
                        filterWorksList(works, filters).map((work, index) => (
                            (index % 3) === 2 && <CardGallery key={work.id} title={work.title} createdAt={work.created_at} id={""}/>
                        ))
                    }
                </div>
            </section>
